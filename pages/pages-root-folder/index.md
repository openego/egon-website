...
<section class="previous-projects row row__wrap">
    ...
    <div class="columns previous-projects__text">
      <p>Our previous projects <a href="https://openegoproject.wordpress.com" title="open_eGo">open_eGo</a> and eGo<sup>n</sup> form the foundation for the current project reGo<sup>n</sup>. 
        In <a href="https://openegoproject.wordpress.com" title="open_eGo">open_eGo</a>, we developed a grid planning tool that covers all grid levels, from the transmission grid to 
